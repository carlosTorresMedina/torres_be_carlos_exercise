...
public class RoleApiTest {
    ...
    @Autowired
    public RoleApiTest(RestTemplate restTemplate, RoleRepository roleRepository) {
    ...
    void shouldGetRolesByUserIdAndTeamId() {
        ...
        RoleDto[] roles = getRole(expectedMembership.getUserId(), expectedMembership.getTeamId())
                .extract().as(RoleDto[].class);
    ...
    @Test
    void shouldFailToGetRolesByUserIdAndTeamIdWhenItDoesNotExist() {
